...
@Component({
    ...
    imports: [UserSidebarComponent, HeaderComponent, FooterComponent, AuthorInfoComponent, AuthorDescriptionComponent, FoundTracksComponent, AuthorAlbumsComponent, AudioPlayerComponent]
})
